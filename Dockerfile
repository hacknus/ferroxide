...
LABEL org.opencontainers.image.title="Ferroxide"
...
LABEL org.opencontainers.image.source="https://github.com/hacknus/ferroxide"
...
VOLUME [ "~/.config/ferroxide" ]

WORKDIR /ferroxide
COPY --from=compilation /src/ferroxide .
